...
const fixedQuestions = [
  {
    question: "¿Cuál es la forma correcta de lavarse las manos?",
    fruit: bombero, // importa tu imagen o emoji
    options: [
      "Frotar solo la palma",
      "Frotar con agua y jabón 20 segundos",
  ...
  {
    question: "¿Qué debes hacer si hay un incendio?",
    fruit: bombero, // importa tu imagen o emoji
    options: [
      "Correr y gritar",
      "Usar el extintor si es pequeño y seguro",
  ...
  {
    question: "¿Cuál es una buena forma de ahorrar energía en casa?",
    fruit: bombero, // importa tu imagen o emoji
    options: [
      "Dejar luces encendidas todo el día",
      "Apagar luces y aparatos que no se usan",
      "Usar la nevera abierta",
      "Encender todos los aparatos a la vez"
    ],
    correctAnswer: 1,
  },
  {
    question: "¿Qué se debe hacer antes de cruzar la calle?",
    fruit: bombero, // importa tu imagen o emoji
    options: [
      "Mirar a ambos lados y cruzar despacio",
      "Correr sin mirar",
      "Solo mirar a la izquierda",
      "Cruzar con el celular en la mano"
    ],
    correctAnswer: 0,
  },
  {
    question: "¿Cuál es la forma correcta de botar la basura?",
    fruit: bombero, // importa tu imagen o emoji
    options: [
      "Tirarla en cualquier lugar",
      "Separar reciclables y no reciclables",
      "Quemarla en casa",
  ...
  return (
    <div className="page-container">
      ...
      <style jsx>{`
        ...
        .option-btn {
            min-height: 65px;         /* mínimo tamaño */
            height: auto;             /* altura automática según contenido */
            border-radius: 50px;
            padding: 18px 12px;       /* vertical u horizontal */
            font-size: 20px;
            border: 3px solid #4caf50;
            background: white;
            font-family: Quicksand;
            white-space: normal;      /* permite salto de línea */
            word-wrap: break-word;    /* fuerza quiebre si es necesario */
            text-align: center; 
        }
