...
import banano from "../assets/objeto-banano.svg";
import manzana from "../assets/objeto-manzana.svg";
import pera from "../assets/objeto-pera.svg";
import pina from "../assets/objeto-pina.svg";
import sandia from "../assets/objeto-sandia.svg";
  ...
  return (
    <div className="page-container">
      ...
      <div className="header">
        ...
        <h2 className="subject-title">Matematicas</h2>
      </div>
      ...
      <div className="apples-area">
        {[...Array(current.count)].map((_, i) => (
          <div key={i} className="apple-wrapper">
            <img src={current.fruit} width={70} alt="fruit" />
          </div>
        ))}
      </div>
