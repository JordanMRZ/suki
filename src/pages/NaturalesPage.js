...
import leon from "../assets/objeto-leon.svg";
import cebra from "../assets/objeto-zebra.svg";
import mono from "../assets/objeto-mono.svg";
import rana from "../assets/objeto-rana.svg";
import pez from "../assets/objeto-pez.svg";
...
const fixedQuestions = [
  {
    ...
    fruit: leon,
    options: ["León", "Tigre", "Pantera", "Guepardo"],
    correctAnswer: 0,
  },
  {
    question: "¿Qué animal es?",
    fruit: cebra,
    options: ["Cebra", "Caballo", "Antílope", "Jirafa"],
    correctAnswer: 0,
  },
  {
    question: "¿Qué animal es?",
    fruit: pez,
    options: ["Salmón", "Pez", "Tiburón", "Delfín"],
    correctAnswer: 1,
  },
  {
    question: "¿Qué animal es?",
    fruit: rana,
    options: ["Rana", "Sapo", "Lagarto", "Tortuga"],
    correctAnswer: 0,
  },
  {
    question: "¿Qué animal es?",
    fruit: mono,
    options: ["Mono", "Chimpancé", "Gorila", "Mandril"],
    correctAnswer: 1, // si tu imagen es un mono común, este es correcto
  },
];
  ...
  return (
    <div className="page-container">
      ...
      <div className="header">
        ...
        <h2 className="subject-title">Naturales</h2>
      </div>
